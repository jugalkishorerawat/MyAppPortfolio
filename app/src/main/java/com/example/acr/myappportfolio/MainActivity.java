package com.example.acr.myappportfolio;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] btn_toast=getResources().getStringArray(R.array.btn_toast);
        ...
        bspot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), btn_toast[0], Toast.LENGTH_SHORT).show();
            }
        });
        ...
        bscore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), btn_toast[1],Toast.LENGTH_SHORT).show();
            }
        });
        ...
        blib.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), btn_toast[2],Toast.LENGTH_SHORT).show();
            }
        });
        ...
        bbuild.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), btn_toast[3], Toast.LENGTH_SHORT).show();
            }
        });
        ...
        bxyz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), btn_toast[4], Toast.LENGTH_SHORT).show();
            }
        });
        ...
        bcaps.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), btn_toast[5], Toast.LENGTH_SHORT).show();
            }
        });
    }
